...
<body background="img/bg/arr.png">
     <!-- Navbar -->
     <nav class="navbar navbar-expand-lg navbar-dark bg-warning text-uppercase">
          <div class="container">
               <a class="navbar-brand" href="index.php">Sistem Administrasi Mahasiswa FEB Universitas Diponegoro</a>
     ...
     gsap.to('.Tambah_data', {
          duration: 2,
          delay: 1,
          text: '<i class=></i>Tambah Data Siswa'
     })
     gsap.from('.navbar', {
          duration: 1,
          y: '-100%',
